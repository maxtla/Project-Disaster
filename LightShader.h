...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext* pDevCon, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView*, ID3D11ShaderResourceView*, XMVECTOR lightDir);
...
public:
	...
	void Release();
	bool Render(ID3D11DeviceContext *pDevCon, int, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView*, ID3D11ShaderResourceView*, XMVECTOR lightDir);
};
