...
Application::Application()
{
	...
	this->pSceneMousePicking = nullptr;
}
...
bool Application::initScenes(HINSTANCE hInstance, HWND hwnd)
{
	...
	if (this->pSceneMousePicking == nullptr)
		this->pSceneMousePicking = new SceneMousePicking();

	if (!this->pSceneMousePicking->initScene(this, hInstance, hwnd))
		return false;
...
void Application::update()
{
	...
	case Scenes::SceneFour:
		...
		break;
	case Scenes::SceneSix:
		this->pSceneMousePicking->updateScene(this);
		break;
	default:
		break;
	}
...
void Application::render()
{
	...
	case Scenes::SceneFour:
		...
		break;
	case Scenes::SceneSix:
		this->pSceneMousePicking->renderScene(this);
		break;
	default:
		break;
	}
...
void Application::Release()
{
	...
	if (this->pSceneHeightMap)
		this->pSceneHeightMap->Release();
	if (this->pSceneMousePicking)
		this->pSceneMousePicking->Release();
}
